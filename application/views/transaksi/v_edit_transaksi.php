            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="header">
                        ...
                        <div class="body">
                            <form action="<?php echo base_url(); ?>transaksi/simpan_edit_data/<?php echo $data_transaksi['id_transaksi'] ?>" method="post" enctype="multipart/form-data" role="form">
                                <div class="row clearfix">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <label for="ina">Nama Siswa/Nasabah</label>
                                          <div class="input-group">
                                            <input disabled="" type="text" class="form-control" required autocomplete="off" name="kd_nasabah" id="search-box" placeholder="Contoh ID Siswa : NIS0001" type="text" value="<?= $data_transaksi['kd_nasabah'] ?>">
                                            <span class="input-group-btn">
                                              <a data-toggle="modal"  data-target="" class="btn btn-primary"><i class="material-icons">search</i></a>
                                            </span>
                                          </div>
                                        <label for="ina">Biodata</label>
                                          ...
                                          <div id="result"></div>
                                          <table class="table">
                                              <tr><td>Nama Siswa/Nasabah</td><td><?= $data_transaksi['nama']; ?></td></tr>
                                              <tr><td>Kelas</td><td><?= $data_transaksi['nama_kelas']; ?></td></tr>
                                              <tr><td>No Telpon</td><td><?= $data_transaksi['notelp']; ?></td></tr>      
                                            </table>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <select class="form-control show-tick" required="" name="jenis_trans" id="jenis_trans">
                                                    <?php if ($data_transaksi['jenis_trans']=='Setor') { ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="number" name="value" id="value" class="form-control" placeholder="Jumalah Uang" required="" value="<?php echo $data_transaksi['value'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="date" name="tanggal" id="tanggal" class="form-control" placeholder="Tanggal" required="" value="<?= $data_transaksi['tanggal'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea class="form-control" name="keterangan" id="keterangan" placeholder="Keterangan" ><?php echo $data_transaksi['keterangan'] ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
