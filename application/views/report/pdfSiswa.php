         ...
         <?php
                ...
                ?>
                  <tr>
                    ...
                    <td width="15%"><?php echo $rows['kd_nasabah']; ?></td>
                    <td width="34%"><?php echo $rows['nama']; ?></td>
                    <td width="12%"><?php echo rupiah($rows['total_tabungan']) ?></td>
                    <td width="12%"><?php echo rupiah($rows['pengeluaran'])?></td>
                    <td width="12%"><?php echo rupiah($rows['total_tabungan'] - $rows['pengeluaran']) ?></td>
